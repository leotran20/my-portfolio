...
const Resume = () => {
    ...
    const {education, workExperience, volunteering, training} = data;
    ...
    return (<section className="resume w-full px-5 lg:px-0 mb-32">
        ...
        {[
            ...
            <Portlet className="mt-10" key={index}>
                ...
                <ul>
                    {
                        data?.map(item => {
                            ...
                            return (
                                <li key={item.id}
                                    className="mt-10 flex flex-col-reverse lg:flex-row justify-between items-center">
                                    <div>
            ...
            <ul>
                {
                    education?.map(item => {
                        ...
                        return (
                            <li key={item.id}
                                className="mt-5 flex flex-col-reverse lg:flex-row justify-between items-center">
                                <div>
